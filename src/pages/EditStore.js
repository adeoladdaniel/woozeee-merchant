    ...
    return (
     ...
     <React.Fragment>
         ...
         <div className="cpheader">
            ...
            <a href="/store"> <button className="cp-but"> Back to Store</button></a>
         </div>
         ...
         <div className="edit-box">
            <Container>
                <Row>
                    <Col md={6}>
                    <br/>
                        <label> <strong className="edit-bold">Store Name</strong></label>

                      <input name="name" value={this.props.store.name}  placeholder="Enter store name" type="name" className="side-form1"/>


                      <br/>
                        <label> <strong className="edit-bold">Store Number</strong></label>

                      <input name="name" value={this.props.store.no}  placeholder="Enter store number" type="number" className="side-form1"/>
                    ...
                    <div className="">
                      <h4>Store Image</h4>
                        ...
                        <form action="/action_page.php">
                          ...
                          <input className="editbut" value="Upload" type="submit"/>
                        </form>
...
export default connect (mapStateToProps, {getUserStore}) (EditStore);